...
<%
    ...
    /* = -------------------------------------------------------------------------- = */
%>
    <form name="cancel_info" method="post" action="pp_ax_hub.jsp">
                ...
                <table width="551" cellspacing="0" cellpadding="16">
                    ...
                    <tr>
                        <td style="background-image:url('./img/boxbg551.gif') ;">
                            <p class="align_left">소스 수정 시 소스 안에 <span class="red bold">※ 주의 ※ </span>표시가 포함된 문장은
                ...
                <table width="527" cellspacing="0" cellpadding="0" class="margin_top_20">
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <input type="image" src="./img/btn_cancel.gif" onclick="return jsf__go_cancel(this.form);" style="width:108;height:37;" alt="취소를 요청합니다" />
